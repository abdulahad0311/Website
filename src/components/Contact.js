...
export const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let response = await fetch("localhost:3000/contact", {
            method : "POST",
            headers : {
                                ...
                                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <Row>
                                            ...
                                            <Col size={12} sm={6} className="px-1">
                                                <input type="tel" value={formDetails.phone} placeholder="Enter Phone" onChange={(e)=> onFormUpdate('phone', e.target.value)} /> 
                                            </Col>
                                            <Col size={12} className="px-1">
                                                <textarea row="6" value={formDetails.message} placeholder="Enter Message" onChange={(e)=> onFormUpdate('message', e.target.value)} /> 
